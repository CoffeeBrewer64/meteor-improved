...
public class PeekCommand extends Command {
    ...
    private static final SimpleCommandExceptionType NOT_HOLDING_SHULKER_BOX = new SimpleCommandExceptionType(Text.literal("You must be holding a shulker block with items in it."));
